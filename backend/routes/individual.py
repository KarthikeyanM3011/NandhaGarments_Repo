...
@individual_bp.route('/individual/dashboard', methods=['GET'])
@require_auth(['individual'])
def get_dashboard():
    try:
...
@individual_bp.route('/individual/measurements', methods=['GET'])
@require_auth(['individual'])
...
@individual_bp.route('/individual/measurements', methods=['POST'])
@require_auth(['individual'])
...
@individual_bp.route('/individual/measurements/<int:measurement_id>', methods=['PUT'])
@require_auth(['individual'])
...
@individual_bp.route('/individual/measurements/<int:measurement_id>', methods=['DELETE'])
@require_auth(['individual'])
...
@individual_bp.route('/individual/orders', methods=['GET'])
@require_auth(['individual'])
def get_orders():
    try:
...
@individual_bp.route('/individual/orders', methods=['POST'])
@require_auth(['individual'])
def create_order():
    try:
        data = request.get_json()
