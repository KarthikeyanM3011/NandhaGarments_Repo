...
const AddMeasurement = ({ measurement, onSubmit, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (measurement) {
        await individualAPI.updateMeasurement(measurement.id, formData);
      } else {
        await individualAPI.addMeasurement(formData);
      }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '40px' }}>
            ...
            <div>
              ...
              <textarea
                name="notes"
                placeholder="Any special notes for the tailor (e.g., preferred fit, style preferences, etc.)"
