...
const IndividualDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      const response = await individualAPI.getDashboard();
        ...
        <div style={{ 
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ 
              ...
              Manage your measurements, browse products, and track your orders
            </p>
            <div style={{
              display: 'flex',
              gap: '24px',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Package size={20} />
                <span>{dashboardData.orders} Orders</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <CreditCard size={20} />
                <span>{formatCurrency(dashboardData.totalRevenue)} Spent</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px' }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, opacity: 0.9 }}>My Measurements</p>
              </div>
            </div>
            <Link 
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px' }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, opacity: 0.9 }}>My Orders</p>
              </div>
            </div>
            <Link 
          ...
          {dashboardData.recentOrders.length > 0 ? (
            ...
            <div style={{ 
              ...
              <p style={{ 
                ...
                Start browsing our products to place your first order
              </p>
              <Link 
                to="/individual/products"
                style={{
