...
const Orders = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await individualAPI.getOrders();
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px', marginBottom: '12px' }}>
                    ...
                    <div>
                      <p style={{ fontSize: '14px', fontWeight: '500', margin: '0 0 4px 0', color: '#374151' }}>
                        Delivery Address
                      </p>
                  ...
                  {selectedOrder.measurementId && (
                    <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>
                      <strong>Measurement ID:</strong> {selectedOrder.measurementId}
                    </p>
                  )}
                </div>
              </div>
