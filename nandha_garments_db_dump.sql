...
--
-- Host: localhost    Database: nandha_garments
-- ------------------------------------------------------
...
CREATE TABLE `individual_profiles` (
  ...
  KEY `idx_user_id` (`user_id`),
  KEY `idx_name` (`name`),
  CONSTRAINT `individual_profiles_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `individual_profiles` WRITE;
/*!40000 ALTER TABLE `individual_profiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `individual_profiles` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `measurements` (
  ...
  KEY `idx_name` (`name`),
  CONSTRAINT `measurements_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`measurement_id`) REFERENCES `measurements` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'admin@nandhagarments.com','$2b$12$w5mWVq2rxwWnBlIN0wniAeop3tWnco7H/nhdwug9ZgCrlGxvvENw6','superadmin','approved','2025-07-14 11:52:19','2025-07-14 11:52:19');
...
-- Dump completed on 2025-07-14 17:22:46
